...
def generate_launch_description():
    ...
    robot_localization_pkg_dir = get_package_share_directory('robot_nav')
    robot_slam_pkg_dir = get_package_share_directory('robot_nav')
    amcl_params_file_subpath = 'config/nav2_params.yaml'
    map_file_subpath = 'map/map_1741862448.yaml'
